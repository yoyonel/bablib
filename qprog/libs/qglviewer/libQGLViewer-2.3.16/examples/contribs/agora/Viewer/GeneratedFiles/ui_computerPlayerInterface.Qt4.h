...
public:
    ...
    void setupUi(QDialog *ComputerPlayerInterface)
    {
        ...
        ComputerPlayerInterface->resize(303, 125);
        ...
        allowedTimeSpinBox->setMaximum(100000);
        allowedTimeSpinBox->setValue(1000);
    ...
    void retranslateUi(QDialog *ComputerPlayerInterface)
    {
        ...
        allowedTimeSpinBox->setToolTip(QApplication::translate("ComputerPlayerInterface", "Maximum computer program reflexion time", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        allowedTimeSpinBox->setSuffix(QApplication::translate("ComputerPlayerInterface", " milliseconds", 0, QApplication::UnicodeUTF8));
