  ...
  <customwidget>
   <class>QGLViewer</class>
    ...
    <pixmap>
     ...
     <slot access="public"> setMouseBinding(int, ClickAction action, bool, Qt::MouseButtons buttonsBefore) </slot>
     <slot access="public"> setMouseBinding(int, MouseHandler handler, MouseAction action, bool) </slot>
     <slot access="public"> setMouseBindingDescription(int, QString, bool, Qt::MouseButtons buttonsBefore) </slot>
     ...
     <slot access="public"> setWheelBinding(Qt::KeyboardModifiers modifiers, MouseHandler handler, MouseAction action, bool) </slot>
