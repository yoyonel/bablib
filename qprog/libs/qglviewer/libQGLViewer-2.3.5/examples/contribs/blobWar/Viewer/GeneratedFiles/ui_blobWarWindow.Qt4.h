...
public:
    ...
    void setupUi(QMainWindow *BlobWarWindow)
    {
        ...
        widget->setGeometry(QRect(0, 29, 600, 453));
        ...
        fileMenu->setGeometry(QRect(0, 0, 700, 420));
        PopupMenu = new QMenu(menubar);
        PopupMenu->setObjectName(QString::fromUtf8("PopupMenu"));
        PopupMenu->setGeometry(QRect(0, 0, 700, 420));
        helpMenu = new QMenu(menubar);
        helpMenu->setObjectName(QString::fromUtf8("helpMenu"));
        helpMenu->setGeometry(QRect(0, 0, 700, 420));
        editMenu = new QMenu(menubar);
        editMenu->setObjectName(QString::fromUtf8("editMenu"));
        editMenu->setGeometry(QRect(397, 279, 173, 169));
