...
class ProjectiveTransfo2D: public Transfo2DElementaire
{
	public :
		...
		void ApplyImageToLocal(double &c, double &l) const
		{
			...
			c  = (m_a2[1] * m_a3[2] - m_a2[2] * m_a3[1]) * ci;
			c += (m_a1[2] * m_a3[1] - m_a1[1] * m_a3[2]) * li;
			c += (m_a1[1] * m_a2[2] - m_a1[2] * m_a2[1]) * 1.;
			c /= h; 
			
			l  = (m_a2[2] * m_a3[0] - m_a2[0] * m_a3[2]) * ci;
			l += (m_a1[0] * m_a3[2] - m_a1[2] * m_a3[0]) * li;
