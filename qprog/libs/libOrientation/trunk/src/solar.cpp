	...
	*/
	...
	/* Formules astronomiques classiques - equinoxe moyen 1900 - precession et nutation
	 ...
	 (les deux ou trois tests effectues n'ont pas montre d'erreur superieure a la demi-minute)
		...
		--------------------------------------------
		Lieu du calcul : Paris (2ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½20'E,48ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½50'N)
		...
		Donnees BDL :
				...
				1			28ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½49'			15ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½05'
				2			33ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½08'			22ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½28'
				3			36ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½26'			33ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½02'
				4			40ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½06'			44ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½47'
				5			45ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½16'			53ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½12'
				6			50ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½40'			56ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½24'
				7			50ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½42'			54ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½08'
				8			44ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½05'			47ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½50'
				9			34ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½46'			38ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½47'
				10			27ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½24'			28ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½44'
				11			23ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½56'			19ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½21'
				12			24ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½59'			14ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½10'
	 ...
	 */
	 /*
	  ...
	  longitude 2ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½20' E
	  latitude 48ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½50' N
	  15/10/1999 10h00 TU	27ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½32'			28ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½58'

	  longitude 1ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½00' E
	  latitude 48ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½50' N
	  15/10/1999 10h00 TU	28ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½58'			28ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½34'

	  longitude 2ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½20' E
	  latitude 47ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½00' N
	  15/10/1999 10h00 TU	28ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½02'			30ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½36'

	  longitude 2ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½16' E
	  latitude 49'53' N
	  13/10/1999 10h31 TU	19ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½11'			30ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½41'
	*/
