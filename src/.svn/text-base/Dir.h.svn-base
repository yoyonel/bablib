...
class Dir {
    public:
        ...
        //--------------------------------------
            ...
            bool contains(QString fileName);            // returns true iff this directory contains a file named <fileName>
        ...
        //---------------------------------------
            ...
            //  - returnds QString::null if no file name is selected (dialog closed or canceled)
