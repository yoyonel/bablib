...
/*! \file geocent.h
    \ingroup transform
    \brief PROJ4 geocent.h implementation file
\details
Implement the conversion between geodetic coordinate (lambda,phi,h) and geocentrique coordinate (X,Y,Z). origin of 
geocentrique coordinate are the ellpsoide center. 
*/
/***************************************************************************/
